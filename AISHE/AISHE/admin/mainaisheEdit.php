<?php
	...
	$eid=$_GET['edit'];
	$q="SELECT * FROM college WHERE code_of_college=".$eid;
					...
					<div id="formdiv" style="display:none;" >
						...
						<div class="card card-primary">
							...
							<form role="form" action="mainaisheAdd.php" method="post">
								<div class="card-body">
									<input type="text" class="form-control" name="collagecode" value="<?php echo $eid; ?>" >
									<div class="form-group">
										...
										<?php
										  ...
										  <div class="form-group">
											...
											<input type="text" class="form-control" name="nameofinst" value="<?php echo $row->name_of_college; ?>" placeholder="Name of the Institution">
										  </div>
										  <div class="form-group">
											<label for="exampleInputEmail1">AISHE Code</label>
											<input type="text" class="form-control" name="codeofaishe" value="<?php echo $row->aishe_code; ?>" placeholder="Enter AISHE Code">
										  </div>
										 <div class="form-group">
											<label for="exampleInputEmail1">Postal Address Line 1</label>
											<input type="text" class="form-control" name="address1" value="<?php echo $row->postal_address_line1; ?>" placeholder="Postal Address Line 1">
										  </div>
										  <div class="form-group">
											<label for="exampleInputEmail1">Postal Address Line 2</label>
											<input type="text" class="form-control" name="address2" value="<?php echo $row->postal_address_line2; ?>" placeholder="Postal Address Line 2">
										  </div>
										 <div class="form-group">
										  <label>Country</label>
				...
				<table id="example" >
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="mainaisheEdit.php?edit=<?php echo $row->code_of_college; ?>" class="btn btn-block btn-success">Edit</a></td>
							<td><a href="mainaisheDelete.php?delet=<?php echo $row->code_of_college; ?>" onclick="return confirm('Are you sure to delete this record?')" class="btn btn-block btn-danger">Delete</a></td>
						</tr>
